...
class TeleportEngine:
    ...
    # Map marker: VEX-encoded version of the v2.1.5 sequence. Anchored on the
    # preceding `vmovsd xmm0,[rdi]` load for uniqueness. Hook site is +4 into
    # the AOB (at the vmovsd store). Confirmed via CE "find what writes to
    # marker address" at 140B5BB53 in the 2026-04 build.
