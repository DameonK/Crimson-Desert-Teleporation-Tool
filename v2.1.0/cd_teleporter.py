...
class TeleporterApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        # World Map button (only if PIL available)
        if _HAS_PIL:
    ...
    def _build_map_window(self):
        ...
        self._map_status_var = tk.StringVar(
            value="Click to set destination \u2014 right-click drag to pan \u2014 scroll to zoom")
        ...
        if self.engine.attached and self.engine.hooks_installed:
            ...
            if apos:
                ...
                if 0 <= px < disp_w and 0 <= py < disp_h:
                    ...
                    draw.text((px + r + 3, py - 8), "You", fill='white')
    ...
    def _map_click_to_game(self, event):
        """Convert a canvas click event to game (x, z) coords."""
