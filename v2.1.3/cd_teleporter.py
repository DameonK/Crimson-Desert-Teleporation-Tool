...
class TeleporterApp(tk.Tk):
    ...
    def _restore_window_geometry(self):
        ...
        if x is not None and y is not None:
            # Tk geometry() can't handle absolute negative coordinates
            # (it interprets -X as "from right edge"), so use Win32 API
            # directly for positioning — same as pywebview does.
